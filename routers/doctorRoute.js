const { applyDoctor,cancelDoctor, approvedDoctor, findDoctor, removeChamber, addChamber, find, findAllChambers, findChamber, updateChamber, allApprovedDoctors} = require('../controllers/doctorController')
