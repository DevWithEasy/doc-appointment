...
export default function Doctor({doctor}){
    ...
    return(
        <div
            className="w-full p-4 flex flex-col items-center text-center bg-white border space-y-5 hover:shadow-md group hover:bg-gray-600 transition-all duration-500"
        >
            <div className='w-[82px] h-[82px] mx-auto flex justify-center items-center rounded-full bg-blue-500 group-hover:bg-white'>
                <img src={api_url+doctor?.user?.image?.url} alt="" className='w-20 h-20 rounded-full border-4'/>
            </div>
            <div
